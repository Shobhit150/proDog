...
import dummy1 from "./dummy_1.jpeg"
export const assets = {
  logo,
  search_icon,
  user_icon,
...
export const productsDummyData = [
  {
    ...
    "name": "Pupper Feast Chicken & Brown Rice",
    "description": "A nutritious blend of farm-raised chicken, wholesome brown rice, and garden vegetables. Rich in protein and fiber, perfect for daily meals and a shiny coat.",
    "price": 39.99,
    "offerPrice": 29.99,
    "image": [
      dummy1,
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Beef & Barley Power Bites",
    "description": "Made with premium beef and hearty barley, these bites are perfect for active dogs needing protein-rich fuel throughout the day.",
    "price": 34.99,
    "offerPrice": 24.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "description": "A grain-free, omega-rich formula with wild salmon and sweet potatoes, perfect for skin, coat, and digestive health.",
    "price": 44.99,
    "offerPrice": 35.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Lamb & Pea Hypoallergenic Formula",
    "description": "Ideal for dogs with food sensitivities, this formula is packed with high-quality lamb protein and easily digestible peas.",
    "price": 49.99,
    "offerPrice": 39.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "description": "Specially formulated for puppies, this blend includes DHA, calcium, and quality proteins to support healthy growth and development.",
    "price": 29.99,
    "offerPrice": 24.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Senior Vitality Mix",
    "description": "A low-fat, high-nutrient mix designed for senior dogs with glucosamine for joint support and antioxidants for immune health.",
    "price": 42.99,
    "offerPrice": 32.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Turkey & Quinoa Digestive Blend",
    "description": "Support your dog’s digestion with this fiber-rich mix of lean turkey and superfood quinoa. Gentle on the stomach, perfect for daily feeding.",
    "price": 39.99,
    "offerPrice": 29.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Goat Milk & Oats Immune Booster",
    "description": "A premium mix enriched with goat milk and oats to support immune strength and gut health. Great as a daily meal or treat.",
    "price": 36.99,
    "offerPrice": 27.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Wild Boar Ancestral Blend",
    "description": "Inspired by a dog’s ancestral diet, this blend features wild boar, ancient grains, and herbs for a natural and protein-rich meal.",
    "price": 55.99,
    "offerPrice": 44.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Duck & Pumpkin Weight Control",
    "description": "Low-fat formula crafted with duck and pumpkin for dogs needing weight management. High in fiber and flavor, low in calories.",
    "price": 37.99,
    "offerPrice": 28.99,
    "image": [ dummy1 ],
    "category": "Dog Food",
